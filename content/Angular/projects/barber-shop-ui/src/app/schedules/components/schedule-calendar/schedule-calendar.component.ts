...
@Component({
  ...
  providers: [
    ...
    {
      provide: SERVICE_TOKEN.DIALOG, useClass: DialogManagerService
    }
  ]
})
export class ScheduleCalendarComponent implements OnDestroy, AfterViewInit, OnChanges {
  ...
  constructor(@Inject(SERVICE_TOKEN.DIALOG) private readonly dialogManagerService: IDialogManagerService) { }
